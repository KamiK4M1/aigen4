            ...
            <table className="shadow-2x w-full justify-center py-5 px-5">
                ...
                <tbody className="text-center">
                    <tr>
                        ...
                        <td className="border-t border-l duration-300 hover:bg-[#0e0e0e]" colSpan={2}>วิทยาการคํานวณ<p className="text-xs">อ.สริภรณ์</p></td>
                        ...
                        <td className="border-t duration-300 hover:bg-[#0e0e0e]" colSpan={2}>ฟิสิกส์ AI<p className="text-xs">อ.สุทธิพงษ์</p></td>
                ...
                <tbody className="text-center">
                    <tr className="">
                        ...
                        <td className="border duration-300 hover:bg-[#0e0e0e]">เคมี<p className="text-xs">อ.ศรัญยา</p></td>
                        <td className="duration-300"></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">แนะแนว<p className="text-xs">อ.พชร</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]" colSpan={2}>ไฟฟ้าและอิเล็กทรอนิกส์เบื้องต้น<p className="text-xs">อ.วรพันธ์</p></td>
                ...
                <tbody className="text-center">
                    <tr className="">
                        ...
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ภาษาอังกฤษ T.<p className="text-xs">T.Jamil</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ศิลปะ<p className="text-xs">อ.นภา</p></td>
                        ...
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ภาษาอังกฤษ T.<p className="text-xs">T.Jamil</p></td>   
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ฟิสิกส์<p className="text-xs">อ.สุทธิพงษ์</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ภาษาอังกฤษ<p className="text-xs">อ.อังศุธร</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">คณิตศาสตร์ AI<p className="text-xs">อ.ภัทราพร</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">LAB AI</td>
                    </tr>
                </tbody>
                <tbody className="text-center">
                    <tr className="">
                        ...
                        <td className="border-l duration-300 hover:bg-[#0e0e0e]" colSpan={2}>เคมี<p className="text-xs">อ.ศรัญยา</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ชีวะ<p className="text-xs">อ.วรปรัชญ์</p></td>
                        <td className="duration-300" ></td>
                        <td className="border-l duration-300 hover:bg-[#0e0e0e]" colSpan={2}>การเขียนโปรแกรม AI<p className="text-xs">อ.พัชรียา</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">ภาษาอังกฤษ<p className="text-xs">อ.อังศุธร</p></td>
                        <td className="border duration-300 hover:bg-[#0e0e0e]">คณิตศาสตร์<p className="text-xs">อ.ภัทราพร</p></td>
                ...
                <tbody className="text-center">
                    <tr className="">
                        ...
                        <td className="border-l border-t duration-300 hover:bg-[#0e0e0e]" colSpan={2}>ชีวะ<p className="text-xs">อ.วรปรัชญ์</p></td>
                        <td className="border-r border-l duration-300 hover:bg-[#0e0e0e]">สุขศึกษา<p className="text-xs">อ.สหชัย , อ.สุทธิษา</p></td>
                        <td className="duration-300"></td>
                        <td className="border-l border-t duration-300 hover:bg-[#0e0e0e]">คณิตศาสตร์ AI<p className="text-xs">อ.ภัทราพร</p></td>
                        <td className="border-l border-t duration-300 hover:bg-[#0e0e0e]">สังคมศึกษา<p className="text-xs">อ.อนุชิต</p></td>
                        <td className="border-l border-t duration-300 hover:bg-[#0e0e0e]">ภาษาไทย<p className="text-xs">อ.พนิดา</p></td>
